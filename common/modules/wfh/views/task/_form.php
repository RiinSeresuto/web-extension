...
<div class="task-form">
	...
	<?php
		if($model->id):
			echo $form->field($model, 'status')->dropDownList([ 'Ongoing' => 'Ongoing', 'On Hold' => 'On Hold', 'Completed' => 'Completed', 'Cancelled' => 'Cancelled', ], ['prompt' => '']);
	...
	<?php
		if($model->id):
			echo $form->field($model, 'attachement_url')->textInput(['maxlength' => true, 'value' => ($model->Url) ? $model->link->url : null, 'autocomplete' => 'off']);
		endif;
	?>
